...
contextBridge.exposeInMainWorld('mc', {
  ...
  searchContent: (query, opts) => ipcRenderer.invoke('content:search', { query, ...(opts || {}) }),
  installContent: (projectId, versionId, instanceId, category, meta) =>
    ipcRenderer.invoke('content:install', { projectId, versionId, instanceId, category, meta }),
  listInstalledContent: instanceId => ipcRenderer.invoke('content:list', { instanceId }),
  uninstallContent: (file, category, instanceId) =>
    ipcRenderer.invoke('content:uninstall', { file, category, instanceId }),
  toggleContent: (file, category, instanceId) => ipcRenderer.invoke('content:toggle', { file, category, instanceId }),
  checkContentUpdates: (instanceId, category) => ipcRenderer.invoke('content:checkUpdates', { instanceId, category }),
  listContentVersions: (projectId, instanceId, category) =>
    ipcRenderer.invoke('content:versions', { projectId, instanceId, category }),
  switchContentVersion: (file, projectId, versionId, instanceId, category) =>
    ipcRenderer.invoke('content:switch', { file, projectId, versionId, instanceId, category }),
  ...
  updateServer: (id, name, ip, categoryId, invite) =>
    ipcRenderer.invoke('servers:update', { id, name, ip, categoryId, invite }),
