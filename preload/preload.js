...
contextBridge.exposeInMainWorld('mc', {
  ...
  installContent: (projectId, versionId, instanceId, category, meta) => ipcRenderer.invoke('content:install', { projectId, versionId, instanceId, category, meta }),
  listInstalledContent: (instanceId) => ipcRenderer.invoke('content:list', { instanceId }),
  uninstallContent: (file, category, instanceId) => ipcRenderer.invoke('content:uninstall', { file, category, instanceId }),
  ...
  listContentVersions: (projectId, instanceId, category) => ipcRenderer.invoke('content:versions', { projectId, instanceId, category }),
  switchContentVersion: (file, projectId, versionId, instanceId, category) => ipcRenderer.invoke('content:switch', { file, projectId, versionId, instanceId, category }),
